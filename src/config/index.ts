...
export const corsAllowOrigin = {
    ...
    origin: [
        "https://coollionfinance-dev.vercel.app",
        "http://localhost:3000"
    ],
};
...
export const cinetpayConfig = {
    ...
    SITE_ID: 622120,
    NOTIFY_URL: `https://api.coollionfi.com${resolve_route(endpoints.apiVersion)}${resolve_route(endpoints.transactions.CinetpayPaymentNotificationUrl)}`,
    TRANSFER_NOTIFY_URL: `https://api.coollionfi.com${resolve_route(endpoints.apiVersion)}${resolve_route(endpoints.transactions.CinetpayTransferNotificationUrl)}`,
