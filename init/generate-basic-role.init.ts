...
export const roles: {
    ...
    specificPermissions?: string[],
        ...
        },
        {
            ...
            public: false,
            accountType: "LENDER",
            subjects: ["Tenant", "AccountType", "UserTenant", "Role",
                "PaymentMethod", "Investment", "Transaction", "Invitation", "InvestmentTerm"],
            exclude: [
                { actions: ["read"], subject: "AccountType", fields: ["restricted", "updatedAt"] },
                { actions: ["create", "update", "delete"], subject: "AccountType" },
                { actions: ["create", "update", "delete"], subject: "InvestmentTerm" },
                { actions: ["read", "delete"], fields: ["deleted", "updatedAt"] },
